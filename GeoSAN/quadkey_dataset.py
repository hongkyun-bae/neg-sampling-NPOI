...
class QuadKeyLBSNDataset(LBSNDataset):  # Inherited in the parent class LBSNDataset -> dataset.py
    ...
    def processing(self, filename, min_freq=100):
        ...
        user2idx = {}
        n_users = 1
        # get loc,time,region,user for each user from file, lat/lon convert to region(quadkey)
        ...
        # 0 user_idx,1 loc,2 t,3 region_quadkey,4 boolean
        # change to matrix,use 6-gram tokens to represent quadkeys
        all_quadkeys = []
