...
#################################################################################
	...
	vocab_size_poi = int(len(data['venueid'].unique()))
	vocab_size_cat = int(len(data['catid'].unique()))
	vocab_size_user = int(len(data['userid'].unique()))
...
# the hour and week to be predicted
	...
	data_train['datainfo'] = {'size_poi':vocab_size_poi,'size_cat':vocab_size_cat,'size_user':vocab_size_user+1} 
