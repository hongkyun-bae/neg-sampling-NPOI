...
data[['week','userid','week','week','deepmove_time','week','week','week','venueid','catid']].to_csv('tweet_tky.txt',sep='',header=False,index=False)
# _, uid, _, _, tim, _, _, tweet, pid, cat_id